...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        // track it.
        Request<?> newRequest =
            getImageRequest(requestUrl, new Listener<Bitmap>() {
                @Override
	...
	protected ImageRequest getImageRequest(String requestUrl, Listener<Bitmap> listener, int maxWidth, int maxHeight,
